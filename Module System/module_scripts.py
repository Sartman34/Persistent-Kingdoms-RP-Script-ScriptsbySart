...
##        (assign, ":unique_id", reg2),
        ...
        (try_begin),
          (eq, ":slot", 0),
          (str_store_string, s0, "@Army relation to commoners set to passive."),
          (call_script, "script_send_coloured_message", ":player_id", colors["acik yesil"], 0),
        (else_try),
          (eq, ":slot", 1),
          (str_store_string, s0, "@Army relation to commoners set to aggressive."),
          (call_script, "script_send_coloured_message", ":player_id", colors["acik kirmizi"], 0),
        (try_end),
        (try_for_agents, ":agent_id"),
