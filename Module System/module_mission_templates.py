...
agent_spawn = (ti_on_agent_spawn, 0, 0, [], [ # server and clients: set up new agents after they spawn
  ...
  (try_begin),
    ...
    (player_slot_eq, ":player_id", slot_player_spawn_state, 1),
    (try_begin),
...
agent_hit = (ti_on_agent_hit, 0, 0, [], [ # server: apply extra scripted effects for special weapons, hitting animals, and when overloaded by armor
  ...
  (try_begin),
    ...
    (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),
      ...
      (agent_unequip_item, ":attacked_agent_id", ":item_id", ":unequip_slot"), # if spawning an item manually, remove it so the engine definitely won't drop a duplicate
    ...
    (agent_set_animation, ":attacked_agent_id", "anim_strike_chest_front_stop"),
