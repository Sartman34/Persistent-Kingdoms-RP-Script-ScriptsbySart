  ...
  return [(ti_on_scene_prop_init,
    ...
    (ti_on_scene_prop_hit,
     [(store_trigger_param, ":instance_id", 1),
      (store_trigger_param, ":hit_damage", 2),
      (store_trigger_param, ":agent_id", 3),
      (call_script, "script_cf_hit_door", ":instance_id", ":hit_damage", resource_class, ":agent_id"),
      ]),
...
scene_props = [
  ...
  ("barrier_8m" ,sokf_invisible|sokf_type_barrier|sokf_moveable,"barrier_8m" ,"bo_barrier_8m" , []),
...
# Persistent Kingdoms Trees
  ...
  ("pw_wheat_field",spr_field_flags(),"pw_wheat_field","bo_pw_wheat_field", spr_hit_field_triggers(resource_item="itm_wheat_sheaf", plant_item="itm_wheat_sack", plant_spr="spr_code_wheat", height=180, full_hp=1020, resource_hp=85, tool_class=item_class_grain_harvesting, regrow_interval=600)),
  ("code_wheat",0,"pw_wheat","0", spr_field_plant_triggers(seeds=4, water=2)), #2000, 50
...
# BeefBacon's Terrain and Landscaping Pack
  ...
  ("pw_event_change_troop_peasant",spr_use_time(1),"wooden_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_peasant", cost=0, after_respawn=True, use_string="str_troop_become")),
  ("pw_event_change_troop_serf",spr_use_time(1),"trident","bo_pw_weapon_big", spr_change_troop_triggers("trp_serf", cost=0)),
  ("pw_event_change_troop_militia",spr_use_time(1),"practice_sword","bo_pw_weapon", spr_change_troop_triggers("trp_militia", cost=0)),
  ("pw_event_change_troop_huntsman",spr_use_time(1),"short_bow","bo_pw_weapon", spr_change_troop_triggers("trp_huntsman", cost=0)),
  ("pw_event_change_troop_craftsman",spr_use_time(1),"pw_repair_hammer","bo_pw_weapon_small", spr_change_troop_triggers("trp_craftsman", cost=0)),
  ("pw_event_change_troop_healer",spr_use_time(1),"package","bobaggage", spr_change_troop_triggers("trp_healer", cost=0)),
  ("pw_event_change_troop_footman",spr_use_time(1),"shield_kite_i","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_footman", cost=0)),
  ("pw_event_change_troop_archer",spr_use_time(1),"hunting_bow","bo_pw_weapon", spr_change_troop_triggers("trp_archer", cost=0)),
  ("pw_event_change_troop_crossbowman",spr_use_time(1),"crossbow_a","bo_pw_weapon", spr_change_troop_triggers("trp_crossbowman", cost=0)),
  ("pw_event_change_troop_lancer",spr_use_time(1),"shield_heater_c","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_lancer", cost=0)),
  ("pw_event_change_troop_man_at_arms",spr_use_time(1),"shield_heater_c","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_man_at_arms", cost=0)),
  ("pw_event_change_troop_knight",spr_use_time(1),"shield_heater_c","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_knight", cost=0)),
  ("pw_event_change_troop_sergeant",spr_use_time(1),"shield_kite_i","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_sergeant", cost=0)),
  ("pw_event_change_troop_engineer",spr_use_time(1),"pw_repair_hammer","bo_pw_weapon_small", spr_change_troop_triggers("trp_engineer", cost=0)),
  ("pw_event_change_troop_master_smith",spr_use_time(1),"pw_repair_hammer","bo_pw_weapon_small", spr_change_troop_triggers("trp_master_smith", cost=0)),
  ("pw_event_change_troop_doctor",spr_use_time(1),"package","bobaggage", spr_change_troop_triggers("trp_doctor", cost=0)),
  ("pw_event_change_troop_sailor",spr_use_time(1),"scimeter","bo_pw_weapon", spr_change_troop_triggers("trp_sailor", cost=0)),
  ("pw_event_change_troop_traveler",spr_use_time(1),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_traveler", cost=0, use_string="str_troop_become")),
  ("pw_event_change_troop_herdsman",spr_use_time(1),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_herdsman", cost=0)),
  ("pw_event_change_troop_lord",spr_use_time(1),"gothic_chair","bogothic_chair", spr_change_troop_triggers("trp_lord", cost=0, use_string="str_troop_assume_role")),
  ("pw_event_change_troop_ruffian",spr_use_time(1),"sledgehammer","bo_pw_weapon", spr_change_troop_triggers("trp_ruffian", cost=0, after_respawn=True, use_string="str_troop_become")),
  ("pw_event_change_troop_brigand",spr_use_time(1),"spiked_club","bo_pw_weapon", spr_change_troop_triggers("trp_brigand", cost=0, after_respawn=True, use_string="str_troop_become")),
  ("pw_event_change_troop_mercenary",spr_use_time(1),"spiked_mace","bo_pw_weapon", spr_change_troop_triggers("trp_mercenary", cost=0, mercenary=True, after_respawn=True, use_string="str_troop_become_for")),
